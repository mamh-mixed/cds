...
func (m *MockWorkflowV2Client) WorkflowV2RunStatus(projectKey, vcsIdentifier, repoIdentifier, wkfName string, runNumber int64) (*sdk.V2WorkflowRun, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WorkflowV2RunStatus", projectKey, vcsIdentifier, repoIdentifier, wkfName, runNumber)
	ret0, _ := ret[0].(*sdk.V2WorkflowRun)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockWorkflowV2ClientMockRecorder) WorkflowV2RunStatus(projectKey, vcsIdentifier, repoIdentifier, wkfName, runNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WorkflowV2RunStatus", reflect.TypeOf((*MockWorkflowV2Client)(nil).WorkflowV2RunStatus), projectKey, vcsIdentifier, repoIdentifier, wkfName, runNumber)
}
...
// WorkflowV2RunStatus mocks base method.
func (m *MockInterface) WorkflowV2RunStatus(projectKey, vcsIdentifier, repoIdentifier, wkfName string, runNumber int64) (*sdk.V2WorkflowRun, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WorkflowV2RunStatus", projectKey, vcsIdentifier, repoIdentifier, wkfName, runNumber)
	ret0, _ := ret[0].(*sdk.V2WorkflowRun)
	ret1, _ := ret[1].(error)
...
// WorkflowV2RunStatus indicates an expected call of WorkflowV2RunStatus.
func (mr *MockInterfaceMockRecorder) WorkflowV2RunStatus(projectKey, vcsIdentifier, repoIdentifier, wkfName, runNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WorkflowV2RunStatus", reflect.TypeOf((*MockInterface)(nil).WorkflowV2RunStatus), projectKey, vcsIdentifier, repoIdentifier, wkfName, runNumber)
}
